...
RUN apk add --no-cache gdbm libsasl snappy gcc make g++ zlib-dev php81-zip zip unzip php81-pecl-mongodb openssl openssl-dev openrc nano bash icu-libs p7zip git php81-intl
